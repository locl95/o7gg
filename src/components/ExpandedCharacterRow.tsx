...
const ExpandedCharacterRow: React.FC<ExpandedCharacterRowProps> = ({char}) => {
    return (
            ...
            <td colSpan={6} className="border border-gray-300 pl-4 pr-8 py-4">
                <div className="grid grid-cols-1 gap-4">
                    <div className="bg-white shadow-md rounded-lg">
                        <div>
                            <div
                                className="bg-gray-600 text-white text-lg font-semibold p-4 flex justify-between items-center">
                                <div>Gear</div>
                                <div className="flex space-x-2">
                                        <span
                                            className="bg-gray-300 text-black text-xs px-2 py-1 rounded-lg flex flex-col items-center space-y-1">
